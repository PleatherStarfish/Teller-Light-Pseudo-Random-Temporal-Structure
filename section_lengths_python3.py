...
## Use this variable to set whether section lengths are reprosented as min. [1], sec. [60], or ms. [60000]
## -----------------------------
sec_min = 60000
## -----------------------------
...
## We want some variation in section start and end times; hense this function
## ---------------------------------------------------------------------------------------
...
## Here we creat one large section between 12. and 15.
...
# <h3>A new variable unique to each instrument is set to the value of "large_section_lengths." Start times of the large sections are randomized, and the durations of each section are recalculated for each instrument indavidually.</h3>
